...
//        System.out.println(account);
    ...
    @Override
    public BaseResponse<?> getAllAccounts(Pageable pageable, String search) {
        Page<AccountResponse> accountResponsePage = accountRepository.findAllAccountsByKeyword(pageable, search);
        return new BaseResponse<>(1, accountResponsePage);
    }
}
